                ...
                for (int i_comp = 0; i_comp < 3; i_comp++)
                {
                    if (i_dep == 0)
                    {
                        if (i_comp == 0)
                        {
                            ...
                            {
                                compType = ComputerType.desktops
                            };
                        }
                        else if (i_comp == 1)
                        {
                    ...
                    else if (i_dep == 1)
                    {
                        if (i_comp == 1)
                        {
                            departments[i_dep, i_comp][3] = new Computer()
                            {
                                compType = ComputerType.laptops
                            };
                        }
                ...
                if (double.TryParse(userTextAction, out userAction))
                {
                    ...
                    else if (userAction > 3 && userAction < 4)
                    {
                        ...
                        if (userAction == 3.1)
                        {
                            ...
                            Console.ForegroundColor = ConsoleColor.DarkGreen;
                            Console.WriteLine("Max value {0}: {1} {2}", infoText, maxComp.CPU, maxComp.CPU_desc);
                            #endregion
                        }
                        else if (userAction == 3.2)
                        {
                            ...
                            Console.ForegroundColor = ConsoleColor.DarkGreen;
                            Console.WriteLine("Max value {0}: {1} {2}", infoText, maxComp.freq, maxComp.freq_desc);
                            #endregion
                        }
                        else if (userAction == 3.3)
                        {
                            ...
                            Console.ForegroundColor = ConsoleColor.DarkGreen;
                            Console.WriteLine("Max value {0}: {1} {2}", infoText, maxComp.HDD, maxComp.HDD_desc);
                            #endregion                        }
                        }
                        else if (userAction == 3.4)
                        {
                            ...
                            Console.ForegroundColor = ConsoleColor.DarkGreen;
                            Console.WriteLine("Max value {0}: {1} {2}", infoText, maxComp.memory, maxComp.memory_desc);
                            #endregion                        }
                        }
                        #endregion
                    }
                    ...
                    else if (userAction == 4)
                    {
                            ...
                            if (comp != null)
                            {
                                foreach (var compElements in comp)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (minValueCPU > currentValueCPU && minValueMemory > currentValueMemory)
                                            minComp = compElements;
                                    }
                                }
                            }
                        ...
                        Console.ForegroundColor = ConsoleColor.DarkGreen;
                        Console.WriteLine("Lowes productivity (CPU and Memory): CPU - {0} {1}, memory {2} {3}", minComp.CPU, minComp.CPU_desc, minComp.memory, minComp.memory_desc);
                        #endregion
                    }
