   ...
   public class Common_db
    {
        ...
        public Common_db(string conn)
        {
            bool rslt;
            myConnectionString = conn;
        ...
        public bool MyTable_read(DataTable usr_Table)
        {
            using (SqlConnection MyConn = new SqlConnection(myConnectionString))
            {
                ...
                myCommand.CommandText = "SELECT * FROM "+ usr_Table.TableName;
                SqlDataAdapter mySqlad = new SqlDataAdapter(myCommand);
                mySqlad.Fill(usr_Table);
            }
                return true;
        }
